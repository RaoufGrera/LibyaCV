...
namespace App\Http\Grant;
    ...
    class SocialGrant extends AbstractGrant{
        ...
        protected function validateUser(ServerRequestInterface $request, ClientEntityInterface $client)
        {
            ...
            $provider_seeker_id = $this->getRequestParameter('provider_seeker_id', $request);
            if (is_null($provider_seeker_id)) {
                throw OAuthServerException::invalidRequest('provider_seeker_id');
            }
        ...
        private function getUserFromSocialNetwork(Request $request){
            ...
            $socialAccount =SocialAccount::where('provider',$request->provider)
                ->where('provider_seeker_id',$request->provider_seeker_id)->first();
