...
jQuery(function($) {
	...
	$("form input[name='insert_exp']").click(function() { // triggred click 
        ...
        if ((start_date_m == "0")|| (end_date_m =="0") || (end_date_y =="0") || (start_date_y =="0")){
			...
			$(".start_date_val").html("<span>!</span><div class='contenttool'><b></b><p>يجب أن يكون تاريخ الأنتهاء gfdأقل من تاريخ البدء .</p></div>");
			val_holder = 1;
                $("#start_date").focus();
			}else if((start_date_y == end_date_y) && (start_date_m >= end_date_m) ){
			$(".start_date_val").html("<span>!</span><div class='contenttool'><b></b><p>يجب أن يكون تاريخ الأنتهاء أقل من تاريخ البدء .</p></div>");
			val_holder = 1;
                $("#start_date").focus();
			}
			else{
