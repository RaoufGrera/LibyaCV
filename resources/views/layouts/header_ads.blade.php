...
<head>
    ...
    <link rel='shortcut icon' type='image/x-icon' href="{{asset('images/simple/logo_blue.png')}}">
...
<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand"  @if(!empty(session('seeker_id'))) href="/" @else  href="/" @endif ><img style=" margin-top: -2px;width: 55px;" alt="Libyacv logo" src="{{asset('images/simple/web.png')}}"/> </a>
