...
if((isset($_GET['domain'])) ){
    if(($_GET['domain']!=""))
        $titleCity= $thejob. "".  $_GET['domain']."" ." ".$titleCity;}else{$titleCity = $thejob." ".$titleCity;}
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="nav-list">
                    ...
                    <div>
                        <a href="search" class="btn btn-danger btn-block">إزالة معايير البحث</a>
                    </div>
                    <br>
...
<!--                                <a href="javascript:void(0)" class="icon-block b t" onclick="ShowModal('job','-jobArray x}');"></a>
-->
...
<br>
                <h1 class="title-page"> {{$titleCity}} {{$titleDomain}}<span  class="ccount">{{$jobCount}} وظيفة </span></h1>
...
<?php }?>
    {{--@if($jobArray['isstar'] ==1) <span class="icon-star star">مميز</span> @endif --}}
                        <div class="job-div">
                            <div class="cv-body">
                                <div class="devimgseeker">
                          <a itemprop='name' title="{{$jobArray['job_name']}}" href="/job/{{$jobArray['desc_id']}}/{{make_slug($jobArray['job_name'])}}"><img class="imgjob-view"
                                     src= @if($jobArray['image'] != ''){{asset('images/company/140px_'.$jobArray['image_code'].'_'.$jobArray['image'])}} @else {{asset('images/simple/140px_company.png')}} @endif /></a></div><div class="line">
                                           ...
                                           <span class="r"><span class="texts "><a class="icon-location {{ $jobArray['city_color'] }} " style="color: #FFFFFF;" href="?city={{ $jobArray['city_name'] }}">{{$jobArray['city_name']}}</a></span><span class="texts"><a class="icon-th " href="?domain={{ $jobArray['domain_name'] }}">{{$jobArray['domain_name']}}</a></span>
                                    ...
                                    var a=0;
                                     if(Object.keys(data).length > 0 ){
                                        ...
                                        var s ='<div class="job-div"><div class="cv-body">'+
                                            '<div class="devimgseeker"><a title="'+this.job_name+'" href="/job/'+ this.desc_id +'/'+this.job_url+'"><img class="imgjob-view" src="'+ this.image+'" /></a></div> <div class="line"><h1 class="display '+this.dir+'"><a title="'+this.job_name+'" id="cvname" href="/job/'+this.desc_id+'/'+this.job_url+'">'+this.job_name+'</a>'+sss+'</h1><span class="r"><span class="texts  "><a style="color: #FFFFFF;" class="icon-location '+this.city_color +'" href="/job/search?city='+this.city_name+'">'+this.city_name+'</a></span><span class="texts"><a class="icon-th" href="/job/search?doamin='+this.domain_name+'">'+this.domain_name+'</a></span></span>'+
