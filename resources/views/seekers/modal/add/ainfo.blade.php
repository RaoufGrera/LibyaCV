        ...
        <div class="mymodal">
            <table>
                <tr>
                    ...
                    <td>
                        <div class="tooltip cert_name_val validation">
...
<tr>
    ...
    <td>
        <textarea  maxlength="3000" style="max-height:250px;width:225px ; max-width:300px;height:200px; min-height:150px;" rows="80" name="info_text" id="info_text"></textarea>
    </td>
</tr>
                <tr>
                    <td width="100">
                    ...
                    <td>
                        <div class="tooltip info_date_val validation">
...
<script type="text/javascript">
    $('#myForm').submit(function(e){
        ...
        editSaveRest('info','#info','#info',dataObject);
    });
</script>
