...
<table style="border-spacing:0;">
    <tr>
        ...
        <td style="" rowspan="6"><span style="line-height:16.8;display: block"></span><img class="imgseeker" height="160" width="160"
                                             src="<?php if($job_seeker->image !=""){echo 'images/seeker/300px_'.$job_seeker->code_image.'_'.$job_seeker->image;} else { echo  $_SERVER['SERVER_NAME'].'/images/test.jpg';} ?>" /></td>
        <?php } ?>
...
<?php if (!empty($job_seeker->goal_text)) { ?>
    <table style="border-spacing:0">
        <tr>
            <td height="6"><span> </span></td>
        </tr>
        <tr>
            <td height="35"><span class="posttitle">الهدف الوظيفي</span></td>
        </tr>
    </table>

    <table class="first" style="border-spacing:0">
        <tr>
            <td><span class="texts"><br><?php echo $job_seeker->goal_text ?></span></td>
        </tr>
    </table>
<?php } ?>
...
<?php if (count($seeker_ed) > 0) { ?>
    <table style="border-spacing:0">
        ...
        <tr>
            <td height="35"><span class="posttitle">المؤهل العلمي</span></td>
        </tr>
    </table>
     ...
     <table  class="first" style="border-spacing:0">
        <?php foreach ($seeker_ed as $row) { ?>
            ...
            <tr>
                <td height="20"><span class="textb"><?php echo $row->univ_name." ".$row->faculty_name; ?></span></td>
            </tr>
            <tr>
                <td height="18">
<span class="texts"><?php $edt=  str_replace("/"," / ",$row->edt_name); echo $edt; if(!empty($row->sed_name)){echo  "، " . $row->sed_name;}
    if (!empty($row->avg)) {
        echo "، " . $row->avg;
            ...
            <tr>
                <td height="20"><span class="texts"><?php echo $row->start_date . " - " . $row->end_date; ?></span></td>
            </tr>
...
<?php if (count($seeker_exp) > 0) { ?>
    <table style="border-spacing:0">
        ...
        <tr>
            <td height="35"><span class="posttitle">الخبرة</span></td>
        </tr>
    </table>
    <table class="first" style="border-spacing:0">
        <?php foreach ($seeker_exp as $row) { ?>
            <tr>
                <td height="10" style="line-height:1"></td>
            </tr>
            <tr>
                <td height="20"><span class="textb"><?php echo $row->exp_name; ?></span></td>
            </tr>
            <tr>
                <td height="19">
            ...
            <tr>
                <td height="17"><span class="texts"><?php echo date('Y-m', strtotime($row->start_date)) . " - ";
                        if ($row->state == 0) {
                            echo date('Y-m', strtotime($row->end_date));
                        } else {
                            echo "الي حد الأن";
                        } ?></span>
                </td>
            ...
            <?php if ($row->exp_desc != "" || $row->exp_desc != " ") { ?>
                <tr>
...
<?php if (count($seeker_lang) > 0) { ?>
    <table style="border-spacing:0">
        ...
        <tr>
            <td height="35"><span class="posttitle">اللغات</span></td>
        </tr>
    </table>
...
<?php if (count($seeker_skills) > 0) { ?>
    ...
    <table style="border-spacing:0">
        ...
        <tr>
            <td height="35"><span class="posttitle">المهارات</span></td>
        </tr>
    </table>
...
if (count($seeker_hobby) > 0) { ?>
    <table style="border-spacing:0">
        ...
        <tr>
            <td height="35"><span class="posttitle">الهوايات</span></td>
        </tr>
    </table>
...
<?php if (count($seeker_info) > 0) { ?>
    <table style="border-spacing:0">
        ...
        <tr>
            <td height="30"><span class="posttitle">مهارات اضافية</span></td>
        </tr>
    </table>
    <table class="first" style="border-spacing:0">
        <?php foreach ($seeker_info as $row) { ?>
            ...
            <tr>
                <td height="20"><span class="textb"><?php echo $row->info_name; ?></span></td>
            </tr>
            <tr>
                <td><span class="texts"><?php echo "سنة: " . $row->info_date; ?></span></td>
            </tr>
        <?php } ?> </table> <?php } ?>
