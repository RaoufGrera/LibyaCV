...
<?php $__env->startSection('image',asset('images/simple/libyacv_logo.png')); ?>
        ...
        <div class="row">
            <div class="col-md-12 testimonials">
                ...
                <div   class="col-md-12" >
                                   ...
                                   <h1 class="center" style="font-size: 28px;    color:  #303030; ">وظائف شاغرة في ليبيا</h1>
                    <p style="text-align: center;font-size: 16px; color: #303030;"><span itemprop="description">نشر وبحث عن وظائف شاغرة في ليبيا، وتصميم السيرة الذاتية باللغة العربية.</span></p>
                    ...
                    <a href="https://facebook.com/LibyaCV" title="Facebook" style="    padding: 16px 16px;" class="btn btn-facebook btn-lg"><i class="icon-facebook-official"></i> فيسبوك</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div  class="col-md-12   center oo sdh cont">
                        <h3 class="center icon-heart">أحدث الوظائف</h3><span class="shr"></span>
                    ...
                    <div class="col-lg-12 cs" >
                        ...
                        <div class="col-lg-12 testimonials" >
                            <div  class="col-lg-8" style="    padding: 20px 5px;">
                                <span style="font-size: 34px">تطبيق ليبيا سـ فِ</span><br><p style="font-size: 110%;">أحصل علي تطبيق [ ليبيا سي في ] من متجر قوقل للتطبيقات لتتمكن من الحصول علي خدمات التالية:- </p>
                                <ul>
                                ...
                                <a style="display: block;text-align: center;" href='https://play.google.com/store/apps/details?id=libyacvpro.libya_cv'><img style="margin: 9px;" width="194px" alt='Get it on Google Play' src='<?php echo e(asset('images/simple/en_badge.png')); ?>'/></a>
  ...
  " src="<?php echo e(asset('images/libyacvapp5.png')); ?>" style="bottom: 0;position: absolute;" />
    ...
    ">
                            ...
                            <div class="centerscv">
                                ...
                                <div class="ody">
                                    <img class="pp" src="<?php echo e(asset('images/simple/print.png')); ?>">
...
<?php $__env->startSection('last'); ?>
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.header2019', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\libyacv\resources\views/welcome2019.blade.php ENDPATH**/ ?>