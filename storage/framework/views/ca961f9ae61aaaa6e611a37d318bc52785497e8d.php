...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/simple/logo_blue.png')); ?>">
    <link rel='shortcut icon' type='image/x-icon' href="<?php echo e(asset('images/simple/logo_blue.png')); ?>">
...
<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand"  <?php if(!empty(session('seeker_id'))): ?> href="/" <?php else: ?>  href="/" <?php endif; ?> ><img style=" margin-top: -2px;width: 55px;" alt="Libyacv logo" src="<?php echo e(asset('images/simple/web.png')); ?>"/> </a>
...
</html><?php /**PATH C:\laragon\www\libyacv\resources\views/layouts/header_ads.blade.php ENDPATH**/ ?>